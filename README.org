...
- *Proper indentation* - consistent, rule-based indentation with customizable offset
...
- *Smart indentation* - context-aware automatic indentation while typing, respecting the same customizable offset
